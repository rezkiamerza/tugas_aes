...
<div class="container mt-3">
  ...
  <form action="codinginput.php" method="POST">
    <div class="mb-3 mt-3">
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control" id="dp" placeholder="Dosen Pengampuh" name="dp" title="Dosen Pengampu" required>
    </div>
    <button type="submit" name="simpan" class="btn btn-primary" >Simpan record</button> 
    <a href="daftar.php" class="btn btn-dark"> Daftar mata kuliah</a>
  </form>
</div>
</body>
</html>
